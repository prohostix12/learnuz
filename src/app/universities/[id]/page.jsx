...
export default function UniversityDetailPage({ params }) {
  ...
  return (
    <div className="universities-page-wrap min-h-screen bg-[#F8FAFF]/30 backdrop-blur-md text-[#0F172A] relative flex flex-col overflow-x-hidden">
      ...
      {/* Detailed Syllabus/Structure Modal */}
      <SyllabusModal
        isOpen={!!activeDetailProgram}
        ...
        buttonClass="w-full py-3.5 rounded-2xl text-sm font-bold bg-[#032B69] hover:bg-[#002f6c] text-white transition-all duration-200 active:scale-95 flex items-center justify-center gap-2 cursor-pointer shadow-lg shadow-blue-900/10"
